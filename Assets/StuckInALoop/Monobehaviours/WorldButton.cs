...
namespace StuckInALoop
{
    public class WorldButton : MonoBehaviour, IDestroyOnClone
    {
        ...
        [SerializeField] private bool playerTriggerOnly;
        ...
        private readonly List<ButtonPresser> touching = new List<ButtonPresser>();
        ...
        {
            if (buttonObject != null) buttonObject.SetColor(DepressedColor);
        }
        ...
        private IEnumerator LerpToPosition(Vector3 pos, float speed)
        {
            ...
            while (d > .001f)
            {
                ...
                buttonObject.transform.localPosition =
                    Vector3.MoveTowards(buttonObject.transform.localPosition, pos, speed);
